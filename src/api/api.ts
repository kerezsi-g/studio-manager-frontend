...
export namespace Admin {
  export class ServiceClient {
    ...
    public async createCollection(
      params: api.CreateCollectionRequest
    ): Promise<api.CreateCollectionResponse> {
    ...
    public async createProject(
      ...
      const resp = await this.baseClient.callAPI(
        'POST',
        `/collections/${encodeURIComponent(collectionId)}/projects`,
...
export namespace Core {
  export class ServiceClient {
    ...
    public async createReview(
      projectId: string,
      params: api.CreateReviewRequest
    ): Promise<api.CreateReviewResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI(
        'POST',
    ...
    public async resolveReview(
      reviewId: string,
      params: api.ResolveReviewRequest
    ): Promise<api.ResolveReviewResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI(
        'PATCH',
...
export namespace File {
  export class ServiceClient {
    ...
    public async getAudioPeaks(
      fileId: string,
      params: api.GetAudioPeaksRequest
    ): Promise<api.GetAudioPeakResponse> {
      ...
      const resp = await this.baseClient.callAPI(
        'GET',
        `/files/${encodeURIComponent(fileId)}/metadata`,
        undefined,
        { query }
      )
    ...
    public async getFileAccessToken(fileId: string): Promise<api.GetFileAccessTokenResponse> {
      ...
      const resp = await this.baseClient.callAPI(
        'GET',
        `/files/${encodeURIComponent(fileId)}/token`
      )
    ...
    public async getFileStream(
      ...
      return this.baseClient.callAPI(
        method,
        `/media/${encodeURIComponent(accessToken)}`,
        body,
        options
      )
    }
